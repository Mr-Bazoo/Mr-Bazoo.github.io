  ...
  return (
    <main>
      ...
      <div style={{ padding: 20, paddingTop: 12 }}>
        ...
        <p className="commandWrapper" style={{ paddingTop: 10 }} ref={scrollRef}>
          <span className="prefix">Hacker</span>@<span className="secondary">Bazootainment</span>:~$ <input id="commandInput" className="commandPromt" style={{ paddingLeft: 5 }} ref={commandRef} onBlur={regainCommandFocus} type="text" value={inputValue} onChange={handleChange} onKeyDown={handleKeyPress}></input>
          <label htmlFor="commandInput" className="hiddenLabel">Enter your command:</label>
        </p>
      </div>
    </main >
  )
